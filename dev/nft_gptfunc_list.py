...
class NFT_info:
    ...
    def get_nft_collection_address_by_name(self, inputs):
        ...
        return contracts
    # 获取基本信息
    @prompts(name="Get_an_NFT_by_contract",
    ...
    # 获取市场概况
    @prompts(name="Get_Market_Rarity",
...
class Collection:
    ...
    @prompts(name="Get_address's_metrics",
